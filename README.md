...
Для запуска программы необходмо запустить класс Main
...
Исходные коды желательно разместить на GitHub, в корне проекта должен содержаться текстовый файл readme.md с описанием задания и описанием того как собрать и запустить программу.
